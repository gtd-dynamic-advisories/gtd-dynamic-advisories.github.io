...
urlpatterns = [
    ...
    path('Pymes/<pyme_id>/', PymeViewSet.as_view({'get': 'get', 'delete': 'delete', 'put': 'put'})),
    path('Pymes/', PymeViewSet.as_view({'get': 'getAll', 'post': 'post'})),
    
    path('Asesors/<asesor_id>/', AsesorViewSet.as_view({'get': 'get', 'delete': 'delete', 'put': 'put'})),
    path('Asesors/', AsesorViewSet.as_view({'get': 'getAll', 'post': 'post'})),
    
    path('Pyme_Asesors/<pyme_asesor_id>/', Pyme_AsesorViewSet.as_view({'get': 'get', 'delete': 'delete', 'put': 'put'})),
